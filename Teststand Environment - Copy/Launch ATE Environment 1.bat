...
ECHO "Teststand" /d "%TESTSTAND_DIRECTORY%" SeqEdit.exe /ENV "%ENVIRONMENT_DIRECTORY%Environment.tsenv"
START "Teststand" /d %TESTSTAND_DIRECTORY% SeqEdit.exe /ENV "%ENVIRONMENT_DIRECTORY%Environment.tsenv"
